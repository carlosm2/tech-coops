...
[Lab148 coop](https://lab148.ca/) | Immersive space, coaching from conceptualization to production for artistic installation with digital technology, libre software development and use | Montreal, Quebec, Canada | Lab148 is a working cooperative founded in 2023, whose mission is to foster collective participation in multimedia installations. |
...
[Tierra Común](https://tierracomun.org/) | Digital Security, Risk Assesment, Free Software Migration, web design | Mexico | 10 years, part of Patio.coop |
...
* [Public WTF JourFixe for everyone (English or German language depending on participants) interested in tech cooperative community life every Wednesday at 9 pm](https://chaos.social/@HackerGeno)
...
* ["Loomio Points"](https://www.loomio.coop/loomio_points.html) - A system to acknowledge the work people did for free to get the project off the ground.
